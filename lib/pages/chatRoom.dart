...
import 'package:sparrow/pages/calls/recieve_call.dart';
                      ...
                      child: Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              Navigator.pushReplacementNamed(
                                  context, '${CallingPage.routeName}video/');
                            },
                          ),
                          IconButton(
                              icon: SvgPicture.asset(
                              ...
                              onPressed: () {
                                Navigator.pushReplacementNamed(
                                    context, '${CallingPage.routeName}audio/');
                              }),
                          IconButton(
                              onPressed: () {},
                        ...
                        if (snapshot.data != null) {
                          ...
                          if (payload['event_type'] == 'sdp.receive') {
                            if (!chatsController.offer.value) {
                              ...
                              chatsController
                                  .createAnswer(payload['caller_mobile']);
                            }
                          } else if (payload['event_type'] == 'chat.receive') {
